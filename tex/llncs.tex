...
%			 In 2018, the automotive company got a patent for a very similar idea of traffic marshaling via a blockchain system \cite{macneille2018vehicle}. 
...
XAIN\footnote{\url{https://www.xain.io/}}
\cite{xainWhitepaper}
% we also have talk about XAIN

Slock.it\footnote{\url{https://slock.it/}}
\cite{slockWhitepaper}
% https://slock.it/

DOVU\footnote{\url{https://dovu.io/}}
\cite{dovuWhitepaper}
%https://dovu.io/
...
%Direct Competitors: 
%
Oaken Innovations\footnote{\url{https://www.oakeninnovations.com/}}
Tesla toolbooth system \cite{oakenTeslaTollbooth}
Water Meter Acorn \cite{oakenWaterMeter}
...
%
Swarm City\footnote{\url{https://swarm.city/}}
%2. https://swarm.city/
...
%
Flying Carpet\footnote{\url{http://www.flyingcarpet.network/}}
...
%
DAV\footnote{\url{https://dav.network/}}
%4. https://dav.network/
%The authors of \cite{davWhitepaper} propose a solution that allows vehicles to discover, communicate and transact with one another using cryptocurrencies. 
