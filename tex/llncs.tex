	...
	\section{System Design and Architecture}
		...
		\subsection{Functional Goals, Quality Goals, Stakeholders and Requirements}
			...
			\subsubsection{Top-Level AOM Goal Model}
				...
				Maybe reference to \cite{leidingM2M} as reference architecture and that the AOM goal model looks pretty similar since it is an instance of what is described in that academic paper.
				
				Note that a sticky man does not exclusively represent human entities but rather all kinds of entities, e.g., humans, vehicles, infrastructure.
			...
			\subsubsection{Refined AOM Goal Model}				
				...
				\begin{figure}[H]
					...
					\caption{Chorus - Goal model refinement \textit{Manage V2X platform}.}	
				...
				\begin{figure}[H]
					...
					\caption{Chorus - Goal model refinement \textit{Enable V2X interaction}.}	
				...
				\begin{figure}[H]
					...
					\caption{Chorus - Goal model refinement \textit{Enable V2X transaction}.}	
