...
\begin{document}
	...
	\keywords{Blockchain, Autonomous Vehicles, V2X Communication, Chorus Technology, Self-Driving Cars, VANET, Smart Contract, Transportation-as-a-Service, TaaS}
...
%				\end{figure}
				...
				\begin{figure}
					...
					\caption{Top-level goal model representation (Source: Adapted and based on \cite{leidingM2M}).}	
...
%			\label{ss:competitor-analysis}
	...
	\section{Conclusion and Future Work}
		...
		This whitepaper presents the Chorus Technology blockchain-based transaction and interaction layer that enables a V2X platform for goods and services. We outline and describe the technical foundations of this new economy, the longterm vision and benefits as well as the different use cases and scenarios of V2X transactions and interactions, e.g., vehicle-to-vehicle (V2V), vehicle-to-human (V2H), or vehicle-to-infrastructure (V2I).
