...
%			- incentive system
		...
		\subsection{Eco-System and Economics}
			...
			The latest version of the prototype uses our ERC-20\footnote{\url{https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md}} compliant COR token on the Rinkeby TestNet for demonstration purposes. However, later version may rely on the ERC-721\footnote{\url{https://github.com/ethereum/EIPs/blob/master/EIPS/eip-721.md}} standard for non-fungible tokens. The idea is to let the insurers hand out ERC-721 tokens to their customers as rewards and burn them when the users trade the accumulated rewards for price reductions or similar.
